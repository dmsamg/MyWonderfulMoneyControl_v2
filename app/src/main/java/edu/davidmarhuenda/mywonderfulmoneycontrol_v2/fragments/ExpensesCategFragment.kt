 ...
 * Use the [ExpensesCategFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ExpensesCategFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ExpensesCategFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ExpensesCategFragment().apply {
